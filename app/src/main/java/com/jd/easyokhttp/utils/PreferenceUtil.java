package com.jd.easyokhttp.utils;
...
public final class PreferenceUtil {
    ...
    public static <T extends Serializable> boolean save(T entity, String key) {
        ...
        SharedPreferences sp = AppUtil.getApp().getSharedPreferences(prefFileName, 0);
    ...
    public static void put(String key, Object object) {
        ...
        SharedPreferences sp = AppUtil.getApp().getSharedPreferences(FILE_NAME,
